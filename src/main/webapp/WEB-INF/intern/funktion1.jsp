...
<body onload="changeTimeGranularity();changeChartType();">
	...
	<div id="completeContentBox">
		<div id="content">
			...
			<div id="chart" style="width: 600px; height: 500px; flow:right; overflow: auto; border-width: 1px; border-style: solid; border-color: black; padding: 5px;">
				<%
			
			ArrayList<ArrayList<String>> data=SQL.query("SELECT * FROM measures;");
